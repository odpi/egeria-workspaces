...
[Nikolaos Livathinos](https://arxiv.org/search/cs?searchtype=author&query=Livathinos,+N), [Christoph Auer](https://arxiv.org/search/cs?searchtype=author&query=Auer,+C), [Maksym Lysak](https://arxiv.org/search/cs?searchtype=author&query=Lysak,+M), [Ahmed Nassar](https://arxiv.org/search/cs?searchtype=author&query=Nassar,+A), [Michele Dolfi](https://arxiv.org/search/cs?searchtype=author&query=Dolfi,+M), [Panos Vagenas](https://arxiv.org/search/cs?searchtype=author&query=Vagenas,+P), [Cesar Berrospi Ramis](https://arxiv.org/search/cs?searchtype=author&query=Ramis,+C+B), [Matteo Omenetti](https://arxiv.org/search/cs?searchtype=author&query=Omenetti,+M), [Kasper Dinkla](https://arxiv.org/search/cs?searchtype=author&query=Dinkla,+K), [Yusik Kim](https://arxiv.org/search/cs?searchtype=author&query=Kim,+Y), [Shubham Gupta](https://arxiv.org/search/cs?searchtype=author&query=Gupta,+S), [Rafael Teixeira de Lima](https://arxiv.org/search/cs?searchtype=author&query=de+Lima,+R+T), [Valery Weber](https://arxiv.org/search/cs?searchtype=author&query=Weber,+V), [Lucas Morin](https://arxiv.org/search/cs?searchtype=author&query=Morin,+L), [Ingmar Meijer](https://arxiv.org/search/cs?searchtype=author&query=Meijer,+I), [Viktor Kuropiatnyk](https://arxiv.org/search/cs?searchtype=author&query=Kuropiatnyk,+V), [Peter W. J. Staar](https://arxiv.org/search/cs?searchtype=author&query=Staar,+P+W+J)  
## Organization  
>   **Input Required**: False  
...
# Don't Link Cited Document Link  
