...
| Tool | URL | Purpose |
|---|---|---|
| [Tech Catalog](tech-catalog.md) | `/catalog` | Search and browse technical assets — infrastructure, data stores, APIs, processes, and technology types — with schemas, context diagrams, and lineage |
...
| [Egeria Explorer](egeria-explorer.md) | `/egeria-explorer` | Browse the type system, glossary terms, governance structures, digital products, information supply chains, and organisational perspectives |
