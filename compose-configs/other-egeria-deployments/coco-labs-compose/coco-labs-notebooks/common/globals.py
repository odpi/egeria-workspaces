...
corePlatformURL      = os.environ.get('corePlatformURL', 'https://host.docker.internal:8443')
corePlatformName     = "Core Platform"

dataLakePlatformURL  = os.environ.get('dataLakePlatformURL', 'https://host.docker.internal:8444')
dataLakePlatformName = "Data Lake Platform"

devPlatformURL       = os.environ.get('devPlatformURL', 'https://host.docker.internal:8445')
...
cocoView1Name = "cocoView-DL-Users"
