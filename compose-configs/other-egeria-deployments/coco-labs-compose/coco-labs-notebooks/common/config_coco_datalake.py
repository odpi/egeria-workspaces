...
def config_coco_datalake(url:str, userid:str):
    ...
    p_client = Platform(cocoMDS1Name, platform_url, 'garygeeke')
    p_client.activate_platform(
        "coco_datalake", [cocoMDS1Name, cocoMDS4Name, 'exchangeDL01', 'governDL01',
                     'cocoView1', 'cocoOLS1']
        )
    ...
    try:
        ...
        pg_config_body = {
            "databaseURL": "~{postgreSQLDatabaseURL}~?currentSchema=mds2_dl_operations_metadata_store",
    ...
    try:
        ...
        f_client.add_postgres_log_destinations(audit_config)
