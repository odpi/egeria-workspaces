...
Usage (run where pyegeria is importable — e.g. inside the freshstart-pyegeria-web
container: ``docker exec freshstart-pyegeria-web sh -c "cd /app && python3 gen_overview_metrics.py"``):
