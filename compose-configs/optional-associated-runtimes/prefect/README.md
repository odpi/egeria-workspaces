...
* **Deploy to Server:**
  ```bash
  docker exec -it egeria-optional-prefect-worker prefect deploy postgres_schema_flow.py:postgres_schema_flow --name postgres-inspector --pool egeria-pool
  ```
...
* **Deploy to Server:**
  ```bash
  docker exec -it egeria-optional-prefect-worker prefect deploy egeria_glossary_flow.py:egeria_glossary_flow --name glossary-inspector --pool egeria-pool
  ```
