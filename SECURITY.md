...
- [OpenSSF Scorecards](https://securityscorecards.dev/) to provide a live, verifiable security score and dashboard for the repository's supply-chain security posture.
