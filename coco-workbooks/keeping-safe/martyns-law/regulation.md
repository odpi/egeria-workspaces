This file describes key parts of the Terrorism (Protection of Premises) Act 2025  that apply to Coco Pharmaceuticals and how they have interpreted the requirements.  There are links to the external references that support the conclusions.

Details of how Coco Pharmaceutical have chosen to comply with the regulations are detailed in later policies and controls since there are many choices on how to do this that require discussion, some at the board level.
...
- For events and premises involving 800+ people, Coco Pharmaceuticals must appoint a responsible person who is a senior employee.  The responsible person must notify the SIA (regulator) of qualifying events and preparedness of premises.  They have 30 days to inform the SIA of any amendments to these arrangements.
- The SIA must be notified if the responsible person changes.
- Failure to comply with this act could result in fines and prosecutions.
- For large premises and large events, Coco Pharmaceuticals may need to make alteration to their premises to safeguard the people present.
### Importance  

Mandatory
### Outcomes  

- Events organized by Coco Pharmaceuticals will be safe (or as safe as possible) for employees and attendees.
- In the event of an attack, event organizers and employees will be more able to act effectively to reduce harm because they have reviewed and rehearsed their responses.
- Events organized by Coco Pharmaceuticals and their premises, will be less vulnerable to attack.
### Results  

### Summary  
 
This regulation requires organized events and venues to take steps to reduce their vulnerability of attack and have plans in place to deal with different types of attack.
### Usage  
...
These classifications are based on number of people expected to be present, including staff.

The types of measures for each of these three are listed in the Act.  The aim is to build on existing Health and Safety laws and ensure the burden on event organizers and premises owners is reasonable.
...
The Home Office has published a supplementary document alongside the statutory guidance entitled ‘Non-statutory supplementary document A: Methods for assessing the reasonable expectation of individuals present at premises and events’. This document provides further information on the methods that can be used to assess the reasonable expectations of individuals present. The document can be found here: [The Terrorism (Protection of Premises) Act 2025 - GOV.UK](https://www.gov.uk/government/publications/the-terrorism-protection-of-premises-act-2025)
...
This glossary extracts the terminology used in the regulation and turns them into a collection of well-defined terms.
### Resource Use  
