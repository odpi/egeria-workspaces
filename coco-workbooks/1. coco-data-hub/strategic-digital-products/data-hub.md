# Data Hub Digital Products

> **Author:** Erin Overview (Information Architect), Peter Profile (Solution Architect)
> **Version:** 1.0
> **Status:** ACTIVE
> **Date:** 2026-09-17
> **Description:** The 4 digital products owned by the Data Hub business system group, each with its data specification and its PostgreSQL data set.
...
| Data Hub Business Summary | `CocoPharma::SolutionComponent::DataHub` | Insight | Order Fulfilment Summary, Manufacturing Status, Inventory Position |
...
1. creates the **digital product** and adds it to the `Data Hub` folder of the catalog;
...
4 products, 10 data structures, 57 data fields.  This file loads after `catalog.md`.
...
Produced by the Data Hub group's `ProductMasterRegister` component.
...
### Membership Rationale
Produced by the Data Hub group's `ProductDataDistribution` component.
...
# Data Hub Business Summary

*Solution component:* `CocoPharma::SolutionComponent::DataHub`  
*Category:* Insight

The summaries the Data Hub assembles from what every business function reports into it: new business from the treatment channel, manufacturing status, inventory position and the current product master feed.  It is the view the business functions share, rather than the detail any one of them holds.
...
### Purpose
Gives every function the same picture of orders, production and stock without each of them integrating with the others.
...
### Membership Rationale
Produced by the Data Hub group's `DataHub` component.
...
### Display Name
Data Hub Business Summary Data Spec

### Qualified Name
DataSpec::Coco::Data Hub Business Summary

### Description
The data structures and fields that make up the Data Hub Business Summary digital product.

### Purpose
Describes the data a subscriber to Data Hub Business Summary receives, structure by structure and field by field, using the Data Field Naming standard.
...
### Qualified Name
DataStructure::Coco::Data Hub Business Summary::Order Fulfilment Summary

### Description
One row per treatment order, its fulfilment and revenue outcome.

### Namespace Path
coco_pharma.data_hub_business_summary
...
### Membership Rationale
The Order Fulfilment Summary structure is part of the Data Hub Business Summary data specification.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Order Fulfilment Summary::OrderIdentifier
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Order Fulfilment Summary::OrderCurrentStatus

### Description
Where the order is in its life, from received to invoiced.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Order Fulfilment Summary::OrderDeliveryDate

### Description
When the therapy was delivered, once it has been.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Order Fulfilment Summary::InvoiceTotalAmount

### Description
The invoiced value of the order.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Order Fulfilment Summary::InvoiceCurrencyCode

### Description
The currency of the invoiced amount.
...
### Qualified Name
DataStructure::Coco::Data Hub Business Summary::Manufacturing Status

### Description
One row per batch, its certification outcome and quantities.
...
### Membership Rationale
The Manufacturing Status structure is part of the Data Hub Business Summary data specification.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Manufacturing Status::BatchIdentifier
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Manufacturing Status::ProductCode
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Manufacturing Status::BatchCertificationStatus

### Description
Whether the batch has been certified, rejected or is awaiting review.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Manufacturing Status::BatchCertificationDate

### Description
When the certification decision was taken.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Manufacturing Status::BatchQuantity
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Manufacturing Status::BatchReleasedQuantity
...
### Qualified Name
DataStructure::Coco::Data Hub Business Summary::Inventory Position

### Description
One row per product per location, the stock held.
...
### Membership Rationale
The Inventory Position structure is part of the Data Hub Business Summary data specification.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Inventory Position::ProductCode
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Inventory Position::WarehouseCode

### Description
The location holding the stock.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Inventory Position::StockLevel
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Inventory Position::StockReservedQuantity

### Description
The quantity allocated to orders.
...
### Qualified Name
DataField::Coco::Data Hub Business Summary::Inventory Position::StockCurrentTimestamp
...
- versionIdentifier: V1.0
- databaseName: coco_pharma
- schemaName: data_hub_business_summary
- schemaDescription: The summaries the Data Hub assembles from what every business function reports into it: new business from the treatment channel, manufacturing status, inventory position and the current product master feed. It is the view the business functions share, rather than the detail any one of them holds.
...
### Membership Rationale
Produced by the Data Hub group's `Egeria Open Metadata and Governance` component.
